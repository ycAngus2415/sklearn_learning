...
def plot_data(lda, X, y, y_pred, fig_index):
    ...
    plt.contour(xx, yy, Z,[.5], linewidths=2., colors='k')
...
def plot_ellipse(splot, mean, cov, color):
    ...
    ell = mpl.patches.Ellipse(mean, 2*v[0]**0.5, 2*v[1]**.5,
...
figure = plt.figure(figsize = (30, 20), dpi = 30)
...
plt.suptitle('Linear Discriminant Analysis vs QuadraticDiscriminantAnalysis', fontsize=28)
plt.show()
